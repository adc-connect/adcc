...
class TestFunctionalityXes(unittest.TestCase):
    ...
    def base_test(self, system: str, ref: dict):
        ...
        assert_allclose(state.oscillator_strength, ref["oscillator_strengths"], atol=1e-4)
        assert_allclose(state.state_dipole_moment, ref["state_dipole_moments"], atol=1e-4)
    ...
    def test_h2o_sto3g_adc2x_xes_singlets(self):
        ...
        ref["oscillator_strengths"] = np.array(
            [
                0.05035461011516018,
                0.03962058660581094,
                0.031211292115201725,
                1.136150679562653e-06,
                0.00016786705751929378,
                1.149042625218289e-09,
                0.0002824180316791623,
                8.321992182153297e-05,
                1.0616015344521101e-10,
    ...
    def test_h2o_ccpvdz_adc2x_xes_singlets(self):
        ...
        ref["oscillator_strengths"] = np.array(
            [
                0.052448756411532765,
                0.04381087006608744,
                0.037804719841347485,
                5.153812050043302e-06,
                3.790267234406099e-05,
            ]
        )
        ref["state_dipole_moments"] = np.array(
            [
