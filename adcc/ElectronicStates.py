...
class ElectronicStates:
    ...
    def _plot_spectrum(self, ylabel: str, yvalues: np.ndarray, xaxis: str = "eV",
                       ...
                       xmin_broadening: float = None, xmax_broadening: float = None,
                       **kwargs):
        """
        ...
        xmin_broadening: float, optional
            The lower x-boundary for the broadening in atomic units. Note that
            the broadening function is computed in atomic units
            before unit conversion.
        xmax_broadening: float, optional
            The upper x-boundary for the broadening in atomic units. Note that
            the broadening function is computed in atomic units
            before unit conversion.
        """
        ...
        if broadening:  # generate a broadened spectrum
            broadened_spectrum: Spectrum = spectrum.broaden_lines(
                width=width, shape=broadening, xmin=xmin_broadening,
                xmax=xmax_broadening
            )
        xaxis = xaxis.lower()
