...
class ExcitedStates:
    ...
    def plot_spectrum(self, broadening="lorentzian", unit="eV", **kwargs):
        ...
        Parameters
        ----------
        broadening : str or None, optional
        ...
        sp = ExcitationSpectrum(energies, self.oscillator_strengths)
        sp.xlabel = "Energy ({})".format(unit)
