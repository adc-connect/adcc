...
##
## ---------------------------------------------------------------------
from .NParticleOperator import NParticleOperator
...
class NParticleDensity(NParticleOperator):
    ...
    operators due to the non-orthonormal AO basis (C^\\dagger S C= 1). While general
    ...
    Expectation values (inner products) of a density and an operator are identical 
    in the AO and MO basis. Note that it is important that only one of them is 
    transformed using the overlap matrix. 
