...
struct type_caster<std::shared_ptr<CachingPolicy_i>> {
    PYBIND11_TYPE_CASTER(std::shared_ptr<CachingPolicy_i>,
                         _("CachingPolicy_i"));

    using CPiCaster = copyable_holder_caster<CachingPolicy_i,
    ...
    bool load(pybind11::handle src, bool b) {
        ...
        auto py_obj_ptr = std::shared_ptr<py::object>{
              new object{py_obj}, [](py::object* py_object_ptr) {
    ...
    static handle cast(std::shared_ptr<CachingPolicy_i> base,
