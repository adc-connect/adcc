...
/**
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(1, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(1, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(2, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(2, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(2, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(2, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(2, 5) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(3, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(3, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(4, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(4, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(4, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(4, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(5, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(5, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(5, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(6, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(6, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_TENSORPROD(7, 1) //
...
#define IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(N_CONTR_IDCS, DIMA, DIMB)                \
  if (DIMA == label_first.size() && DIMB == label_second.size() &&                    \
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 1, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 1, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 2, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 2, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 2, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 2, 4) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 2, 7) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 3, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 3, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 4, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 4, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 4, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 4, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 4, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 4, 6) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 5, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 5, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 6, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 6, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 6, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 6, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 7, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 7, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 7, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 8, 1) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(1, 8, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 2, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 2, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 2, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 2, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 2, 7) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 3, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 3, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 4, 8) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 5, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 5, 7) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 6, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 6, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 7, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 7, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 7, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 7, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 8, 2) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 8, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(2, 8, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 3, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 3, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 3, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 3, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 3, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 4, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 4, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 4, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 4, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 4, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 4, 8) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 5, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 5, 8) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 6, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 6, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 7, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 7, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 7, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 7, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 7, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 8, 3) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 8, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 8, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(3, 8, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 4, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 4, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 4, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 4, 8) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 5, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 5, 8) //
    ...
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 6, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 6, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 7, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 7, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 7, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 7, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 7, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 8, 4) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 8, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 8, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 8, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(4, 8, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 5, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 5, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 5, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 6, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 6, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 6, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 6, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 7, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 7, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 7, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 7, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 8, 5) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 8, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 8, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(5, 8, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 6, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 6, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 7, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 7, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 7, 8) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 8, 6) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 8, 7) //
    IF_DIMENSIONS_MATCH_EXECUTE_CONTRACT(6, 8, 8) //
