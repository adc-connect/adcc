 ...
 * df23         Delta-Fock between spaces 2 and 3 of the ADC matrix
 ...
 */
size_t fill_dip_doubles_guesses(std::vector<std::shared_ptr<Tensor>> guesses_d,
                               std::shared_ptr<const MoSpaces> mospaces,
                               std::shared_ptr<Tensor> df23,
