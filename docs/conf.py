...
def determine_tag():
    ...
    tag = subprocess.check_output(
        ["git", "tag", "--points-at"] + [f"{commit}"], universal_newlines=True
    ).strip()
    return tag
...
man_pages = [(master_doc, "adcc", "adcc Documentation", [author], 1)]
...
# Breathe settings
libadcc_doc_dir = os.path.abspath(os.path.dirname(__file__)) + "/../build/libadcc_docs/xml"
breathe_projects = {
    "libadcc": libadcc_doc_dir,
}
